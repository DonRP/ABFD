...
translate italian strings:
    ...
    new "[jn], mio [jnR.NPClabel], è un ex Navy Seals. Da ragazzo era un duro e un ribello, ma la vita militare lo ha cambiato."
    ...
    new "[bff] è il mio [bffR.NPClabel]. Andiamo nella stessa scuola e siamo nella stessa classe."

    # game/values_text.rpy:20
    old "{b}Orlando Catholic Institute{/b}"
    new "{b}Istituto cattolico di Orlando{/b}"
